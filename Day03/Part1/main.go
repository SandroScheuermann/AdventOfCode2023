...
const input string = `....937..........309.............191..............745.................913......................................256................891.......
...
func isAdjacentToSpecialChar(inputLines []string, i, start, length int) bool {
	for x := -1; x <= 1; x++ {
		for y := -1; y <= 1; y++ {
			for j := 0; j < length; j++ {
				newI, newJ := i+x, start+j+y
				if newI >= 0 && newI < len(inputLines) && newJ >= 0 && newJ < len(inputLines[newI]) && isSpecialChar(rune(inputLines[newI][newJ])) {
					return true
				}
			}
		}
...
func main() {
	...
	for i, line := range inputLines {
		...
		for _, match := range matches {
			...
			numberStr := line[start:end]
			if isAdjacentToSpecialChar(inputLines, i, start, len(numberStr)) {
				number, _ := strconv.Atoi(numberStr)
				sum += number
				fmt.Printf("\nNúmero %s é válido", numberStr)
			}
		}
	}
